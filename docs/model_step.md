...
3. **`MutatingStep<E, I>`**: A step that modifies a mutable repository.
...
#### **3. `LoadCsvStep<E, I>`** (concrete wrapper implementation of AddCsvStep)
...
These steps change the data within a repository but do not replace elements.

#### **4. `UpdateEachStep<E, I>`**

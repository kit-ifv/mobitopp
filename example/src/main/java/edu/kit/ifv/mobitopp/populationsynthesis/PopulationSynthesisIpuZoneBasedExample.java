...
import edu.kit.ifv.mobitopp.populationsynthesis.region.IsolatedZonesDemandCalculator;
...
public class PopulationSynthesisIpuZoneBasedExample extends PopulationSynthesis {

	public PopulationSynthesisIpuZoneBasedExample(SynthesisContext context) {
		super(context);
	}
	...
	protected DemandDataCalculator createCalculator(
		...
		DemandDataForDemandRegionCalculator communityCalculator = new IsolatedZonesDemandCalculator(
				zoneCalculator);
		return new DemandRegionDemandCalculator(regions(), communityCalculator, steps,
				impedance());
	}
	...
	private PopulationSynthesisStep workDestinationSelector(
			final DemandRegionRelationsRepository commuterRelations) {

...
@Slf4j
public class PopulationSynthesisIpuZoneBasedStarter {
	...
	public static WrittenConfiguration startSynthesis(File configurationFile) throws Exception {
	...
	public static void startSynthesis(SynthesisContext context) {
		...
		PopulationSynthesis synthesizer = new PopulationSynthesisIpuZoneBasedExample(context);

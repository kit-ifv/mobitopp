...
public class MatrixValidator {
	...
	private Collection<TravelTimeMatrixType> travelTimeTypes() {
		return EnumSet.complementOf(EnumSet.of(TravelTimeMatrixType.truck,
				TravelTimeMatrixType.ride_pooling, TravelTimeMatrixType.ride_hailing,
				TravelTimeMatrixType.premium_ride_hailing, TravelTimeMatrixType.taxi,
				TravelTimeMatrixType.park_and_ride, TravelTimeMatrixType.bikesharing,
				TravelTimeMatrixType.e_scooter, TravelTimeMatrixType.passenger));
	}
	...
	private Collection<CostMatrixType> requiredCostMatrices() {
		return EnumSet.of(CostMatrixType.car, CostMatrixType.publictransport,
				CostMatrixType.parking, CostMatrixType.distance, CostMatrixType.parkingstress,
				CostMatrixType.constant);
	}

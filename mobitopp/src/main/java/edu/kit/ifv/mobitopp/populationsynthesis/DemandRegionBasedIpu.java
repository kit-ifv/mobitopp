...
public class DemandRegionBasedIpu implements DemandDataForDemandRegionCalculator {
	...
	public DemandRegionBasedIpu(final Results results,
		final DataRepositoryForPopulationSynthesis dataRepository, final SynthesisContext context,
		final DemandCreatorFactory demandCreatorFactory) {
	...
	private void create(final List<WeightedHousehold> households, final DemandRegion region,

...
public class DynamicHouseholdAttribute implements Attribute {
  ...
  private final Function<Demography, ContinuousDistributionIfc> selectDistribution;
  ...
  public DynamicHouseholdAttribute(String prefix,
      ...
      Function<Demography, ContinuousDistributionIfc> selectDistribution) {
    super();
    this.prefix = prefix;
  ...
  public Constraint createConstraint(Demography demography) {
    ContinuousDistributionItem item = selectDistribution.apply(demography).getItem(lowerBound);

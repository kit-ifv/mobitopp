...
public class HouseholdAttributes {
  ...
  public int hashCode() {
    return Objects
        .hash(canChargePrivately, domCode, homeLocation, homeZone, id, incomeClass,
            monthlyIncomeEur, nominalSize, numberOfNotSimulatedChildren, oid, totalNumberOfCars);
  }
  ...
  public String toString() {
    return "HouseholdAttributes [oid=" + oid + ", id=" + id + ", nominalSize=" + nominalSize
        ...
        + totalNumberOfCars + ", monthlyIncomeEur=" + monthlyIncomeEur + ", incomeClass="
        + incomeClass + ", canChargePrivately=" + canChargePrivately + "]";
  }

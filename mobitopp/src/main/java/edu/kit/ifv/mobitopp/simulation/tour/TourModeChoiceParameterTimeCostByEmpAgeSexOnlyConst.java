...
public class TourModeChoiceParameterTimeCostByEmpAgeSexOnlyConst extends TourModeChoiceParameterTimeCostByEmpAgeSexBase 
...
Likelihood ratio test : chisq = 129000 (p.value = <2e-16)
	...
	public TourModeChoiceParameterTimeCostByEmpAgeSexOnlyConst() {

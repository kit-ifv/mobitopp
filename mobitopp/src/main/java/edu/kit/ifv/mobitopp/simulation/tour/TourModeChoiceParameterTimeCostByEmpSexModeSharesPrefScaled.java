...
public class TourModeChoiceParameterTimeCostByEmpSexModeSharesPrefScaled 
...
Likelihood ratio test : chisq = 85700 (p.value = <2e-16)
	...
	public TourModeChoiceParameterTimeCostByEmpSexModeSharesPrefScaled() {
	
		walking																				 = 0.0	- 0.4;
		walking_intrazonal														 = 0.0	+ 0.7;
		walking_day_Saturday                           = 0.0	- 0.2;
		walking_day_Sunday                           	 = 0.0	- 0.2;
		
		// curr: v7, next: v7
		
		cardriver                                   = -0.293352 - 0.25;				//    0.093572   -3.14  0.00172 ** 
		carpassenger                                = -3.191544	+ 0.2;				//    0.113864  -28.03  < 2e-16 ***
		...
		carpassenger_intrazonal                     = -1.162939	- 0.2;				//    0.048553  -23.95  < 2e-16 ***
		...
		carpassenger_day_Saturday                    = 0.640869 + 0.2;				//    0.053048   12.08  < 2e-16 ***
		...
		carpassenger_day_Sunday                      = 0.228197 + 0.1;				//    0.061823    3.69  0.00022 ***
	...
	protected void init() {
		...
		this.parameterWalk.put("SHARES_AS_PREFERENCE", 			scaling*walking_preference);
		this.parameterBike.put("SHARES_AS_PREFERENCE", 			scaling*cycling_preference);
		this.parameterCar.put("SHARES_AS_PREFERENCE", 			scaling*cardriver_preference);
		this.parameterPassenger.put("SHARES_AS_PREFERENCE", scaling*carpassenger_preference);
		this.parameterPt.put("SHARES_AS_PREFERENCE", 				scaling*publictransport_preference);
	}

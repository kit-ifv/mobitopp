...
public class TourModeChoiceParameterTimeCostByEmpSexPreferenceML 
	extends TourModeChoiceParameterBaseTimeCostByEmpSex 
	implements TourModeChoiceParameter
{

	protected Double	walking_preference					= 1.0 ;
	protected Double	cardriver_preference				= 1.0 ;
	protected Double	carpassenger_preference			= 1.0 ;
	protected Double	cycling_preference					= 1.0 ;
	protected Double	publictransport_preference	= 1.0 ;
...
Simulation based on 50 draws
	...
	public TourModeChoiceParameterTimeCostByEmpSexPreferenceML() {
	
		walking																				 = 0.0;
		walking_intrazonal														 = 0.0;
		...
		cardriver                                    = 1.35489	+ 0.8;			//    0.11478   11.80  < 2e-16 ***
		carpassenger                                = -5.25419;			//    0.15425  -34.06  < 2e-16 ***
		cycling                                     = -3.17427;			//    0.17724  -17.91  < 2e-16 ***
		publictransport                             = -0.17270	+ 1.4;			//    0.12922   -1.34  0.18138    
		
		cardriver_intrazonal                        = -1.82384 - 1.2;			//    0.05227  -34.89  < 2e-16 ***
		carpassenger_intrazonal                     = -1.64235 - 0.2;			//    0.06271  -26.19  < 2e-16 ***
		cycling_intrazonal                           = 0.15240	+ 0.1;			//    0.07342    2.08  0.03793 *  
		...
		cardriver_sex_female                        = -0.90219 + 0.1;			//    0.08611  -10.48  < 2e-16 ***
		...
		cardriver_employment_homekeeper             = -0.33496	+ 0.5;			//    0.15598   -2.15  0.03176 *  
		...
		cardriver_employment_retired                = -0.83690;			//    0.16404   -5.10  3.4e-07 ***
		...
		carpassenger_employment_pupil                = 0.36108;			//    0.29453    1.23  0.22021    
		...
		carpassenger_purpose_private_business        = 1.51188;			//    0.11679   12.95  < 2e-16 ***
		...
		carpassenger_purpose_visit                   = 1.35704;			//    0.12171   11.15  < 2e-16 ***
		...
		carpassenger_purpose_shopping_grocery        = 1.48860;			//    0.11499   12.95  < 2e-16 ***
		cycling_purpose_shopping_grocery            = -0.50424;			//    0.12445   -4.05  5.1e-05 ***
		...
		carpassenger_purpose_shopping_other          = 2.15026;			//    0.13487   15.94  < 2e-16 ***
		...
		cardriver_purpose_leisure_indoors           = -1.08655;			//    0.10142  -10.71  < 2e-16 ***
		...
		cardriver_purpose_leisure_outdoors           = 0.45021;			//    0.09488    4.75  2.1e-06 ***
		...
		publictransport_purpose_leisure_other       = -1.15562;			//    0.11390  -10.15  < 2e-16 ***
		
		cardriver_purpose_leisure_walk              = -2.92575	+ 0.8;			//    0.10518  -27.82  < 2e-16 ***
		carpassenger_purpose_leisure_walk           = -0.47612	+ 0.8;			//    0.13987   -3.40  0.00066 ***
		...
		carpassenger_day_Saturday                    = 0.70481 + 0.5;			//    0.05991   11.77  < 2e-16 ***
		...
		carpassenger_day_Sunday                      = 0.34791 + 0.5;			//    0.07072    4.92  8.7e-07 ***
	...
	protected void init() {
		...
		this.parameterWalk.put("PREFERENCE", walking_preference);
		this.parameterBike.put("PREFERENCE", cycling_preference);
		this.parameterCar.put("PREFERENCE", cardriver_preference);
		this.parameterPassenger.put("PREFERENCE", carpassenger_preference);
		this.parameterPt.put("PREFERENCE", publictransport_preference);
	}

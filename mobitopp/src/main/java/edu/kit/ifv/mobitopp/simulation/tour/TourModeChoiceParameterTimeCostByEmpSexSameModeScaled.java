...
public class TourModeChoiceParameterTimeCostByEmpSexSameModeScaled 
...
Likelihood ratio test : chisq = 72000 (p.value = <2e-16)
	...
	public TourModeChoiceParameterTimeCostByEmpSexSameModeScaled() {
		...
		// current v21, next: v21
		
		cardriver                                    = 0.238823 - 0.15;				//    0.080633    2.96  0.00306 ** 
		carpassenger                                = -4.064172;				//    0.108346  -37.51  < 2e-16 ***
		cycling                                     = -1.683817 - 0.6;				//    0.108350  -15.54  < 2e-16 ***
		publictransport                             = -0.095500 + 0.55;				//    0.090639   -1.05  0.29205    
		
		cardriver_intrazonal                        = -1.057085  - 0.55;				//    0.035471  -29.80  < 2e-16 ***
		carpassenger_intrazonal                     = -0.927258;				//    0.045518  -20.37  < 2e-16 ***
		cycling_intrazonal                           = 0.059232 + 0.7;				//    0.048813    1.21  0.22496    
		publictransport_intrazonal                  = -3.106246 - 0.55;				//    0.092794  -33.47  < 2e-16 ***
		...
		cardriver_sex_female                        = -0.586067	 + 0.15;				//    0.043685  -13.42  < 2e-16 ***
		carpassenger_sex_female                      = 0.468136;				//    0.047626    9.83  < 2e-16 ***
		cycling_sex_female                          = -0.579995;				//    0.053125  -10.92  < 2e-16 ***
		publictransport_sex_female                  = -0.000712;				//    0.044059   -0.02  0.98710    
		
		cardriver_employment_parttime               = -0.054832 	+ 0.3;				//    0.064567   -0.85  0.39576    
		carpassenger_employment_parttime             = 0.077768;				//    0.085986    0.90  0.36577    
		...
		cardriver_employment_marginal                = 0.145099;				//    0.098105    1.48  0.13914    
		carpassenger_employment_marginal             = 0.573619;				//    0.128741    4.46  8.4e-06 ***
		cycling_employment_marginal                  = 0.564679;				//    0.130669    4.32  1.6e-05 ***
		...
		cardriver_employment_retired                = -0.349140		+ 0.1;				//    0.083344   -4.19  2.8e-05 ***
		carpassenger_employment_retired             = -0.137111		- 0.3;				//    0.108476   -1.26  0.20624    
		cycling_employment_retired                  = -0.276320;				//    0.142262   -1.94  0.05210 .  
		publictransport_employment_retired           = 0.100817		+ 0.1;				//    0.115184    0.88  0.38143    
		...
		publictransport_employment_pupil             = 0.103886;				//    0.182912    0.57  0.57007    
		
		walking_employment_pupil             					= 0.0			+  0.2;		
		...
		cardriver_employment_apprentice              = 0.205212;				//    0.239701    0.86  0.39193    
		...
		cardriver_age_18to25                         = 0.425448;				//    0.125083    3.40  0.00067 ***
		...
		cardriver_age_51to60                         = 0.123821;				//    0.045310    2.73  0.00628 ** 
		carpassenger_age_51to60                      = 0.379313;				//    0.063662    5.96  2.5e-09 ***
		cycling_age_51to60                          = -0.179067;				//    0.075555   -2.37  0.01779 *  
		publictransport_age_51to60                   = 0.131555;				//    0.067905    1.94  0.05270 .  
		
		cardriver_age_61to70                         = 0.043212;				//    0.073546    0.59  0.55683    
		carpassenger_age_61to70                      = 0.534171;				//    0.094954    5.63  1.8e-08 ***
		cycling_age_61to70                          = -0.072971;				//    0.126955   -0.57  0.56544    
		publictransport_age_61to70                   = 0.284048;				//    0.104177    2.73  0.00640 ** 
		
		cardriver_age_71plus                         = 0.190858;				//    0.086242    2.21  0.02689 *  
		carpassenger_age_71plus                      = 0.702001;				//    0.109566    6.41  1.5e-10 ***
		...
		cardriver_purpose_service                    = 0.563007 + 0.3;				//    0.066938    8.41  < 2e-16 ***
		...
		carpassenger_purpose_visit                   = 1.002966;				//    0.099250   10.11  < 2e-16 ***
		...
		cardriver_purpose_leisure_walk              = -2.481828 + 1.0;				//    0.080748  -30.74  < 2e-16 ***
		carpassenger_purpose_leisure_walk           = -0.542581;				//    0.113955   -4.76  1.9e-06 ***
		cycling_purpose_leisure_walk                = -1.225735;				//    0.102362  -11.97  < 2e-16 ***
		publictransport_purpose_leisure_walk        = -2.233804;				//    0.128240  -17.42  < 2e-16 ***
		
		cardriver_purpose_other                      = 0.005454;				//    0.438033    0.01  0.99007    
		carpassenger_purpose_other                   = 1.642237 + 1.0;				//    0.376211    4.37  1.3e-05 ***
		cycling_purpose_other                       = -1.761051;				//    1.059956   -1.66  0.09663 .  
		publictransport_purpose_other               = -0.325086;				//    0.581850   -0.56  0.57636    
		
		cardriver_day_Saturday                       = 0.024280	+ 0.1;				//    0.044152    0.55  0.58238    
		carpassenger_day_Saturday                    = 0.412240 + 0.45;				//    0.051198    8.05  8.9e-16 ***
		cycling_day_Saturday                        = -0.072867	- 0.2;				//    0.074157   -0.98  0.32580    
		publictransport_day_Saturday                 = 0.089564	+ 0.1;				//    0.064031    1.40  0.16188    
		
		cardriver_day_Sunday                        = -0.322378;				//    0.053925   -5.98  2.3e-09 ***
		carpassenger_day_Sunday                      = 0.034224 + 0.25;				//    0.060350    0.57  0.57065    
		cycling_day_Sunday                          = -0.294217;				//    0.088201   -3.34  0.00085 ***
		publictransport_day_Sunday                  = -0.484080 + 0.1;				//    0.079172   -6.11  9.7e-10 ***
		...
		cycling_firsttour                            = 0.225874	+ 0.4;				//    0.073715    3.06  0.00218 ** 
	...
	protected void init() {
		...
		this.parameterWalk.put("SAME_MODE_AS_BEFORE", scaling*walking_same_mode);
		this.parameterBike.put("SAME_MODE_AS_BEFORE", scaling*cycling_same_mode);
		this.parameterCar.put("SAME_MODE_AS_BEFORE", scaling*cardriver_same_mode);
		this.parameterPassenger.put("SAME_MODE_AS_BEFORE", scaling*carpassenger_same_mode);
		this.parameterPt.put("SAME_MODE_AS_BEFORE", scaling*publictransport_same_mode);

...
public class TourModeChoiceParameterTimeCostByEmpSexUsedBeforeScaled 
...
Likelihood ratio test : chisq = 78600 (p.value = <2e-16)
	...
	public TourModeChoiceParameterTimeCostByEmpSexUsedBeforeScaled() {
	
		walking																				 = 0.0	- 0.15;
		walking_intrazonal														 = 0.0	+ 0.05;
		walking_day_Saturday                           = 0.0;
		walking_day_Sunday                           	 = 0.0;
		
		// curr: v4, next: v4

		cardriver                                    = 0.0891209 + 0.25;			//    0.087729    1.02  0.30970    
		carpassenger                                = -3.411138;			//    0.110145  -30.97  < 2e-16 ***
		cycling                                     = -1.711047;			//    0.117548  -14.56  < 2e-16 ***
		publictransport                             = -0.243770	+ 0.7;			//    0.097744   -2.49  0.01263 *  
		
		cardriver_intrazonal                        = -1.048605 - 0.9;			//    0.036252  -28.93  < 2e-16 ***
		carpassenger_intrazonal                     = -1.047112 - 0.25;			//    0.046122  -22.70  < 2e-16 ***
		cycling_intrazonal                           = 0.001453	+ 0.15;			//    0.051368    0.03  0.97743    
		publictransport_intrazonal                  = -2.991935	- 0.7;			//    0.093932  -31.85  < 2e-16 ***
		...
		walking_employment_marginal          				= 0.0				- 0.2;
	...
	protected void init() {
		...
		this.parameterWalk.put("USED_BEFORE", scaling*walking_usedbefore);
		this.parameterBike.put("USED_BEFORE", scaling*cycling_usedbefore);
		this.parameterCar.put("USED_BEFORE", scaling*cardriver_usedbefore);
		this.parameterPassenger.put("USED_BEFORE", scaling*carpassenger_usedbefore);
		this.parameterPt.put("USED_BEFORE", scaling*publictransport_usedbefore);

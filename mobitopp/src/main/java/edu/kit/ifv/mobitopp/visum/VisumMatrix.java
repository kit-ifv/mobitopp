...
public class VisumMatrix implements Matrix<Float> {
	...
	public void set(int row, int col, Float val) {
		throw warn( new java.lang.UnsupportedOperationException(), log);
	}
	...
	/**
	 * Returns a new matrix by scaling the values of this matrix using the given
	 * factor.
	 * 
	 * @param factor to scale the matrix
	 ...
	 * 
	 * @param increment value to add to the values of this matrix
	 * @return added matrix
	 */
	...
	/**
	 * Returns a new matrix by calculating the minimum of the values of this and the
	 * given matrix.
	 * 
	 * @param other matrix for minimum calculation

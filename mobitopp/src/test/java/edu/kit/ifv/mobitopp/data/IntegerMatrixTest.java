...
public class IntegerMatrixTest {
	...
	@Test
	void accessUnavailableZone() throws Exception {
		ZoneId zone = newZoneId(0);
		IntegerMatrix matrix = new IntegerMatrix(emptyList());

		assertThrows(AssertionError.class, () -> matrix.get(zone, zone));
	}
}

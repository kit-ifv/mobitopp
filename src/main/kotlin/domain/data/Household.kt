...
// solution to problem: KSP will not perform multi-round annotation processing :(
// to be able to generate Mutable classes that depend on generated mutable classes,
// we introduce this intermediate type that merely delegates
// class MutableHousehold(
//    id: HouseholdId,
//    seed: Long,
//    scope: HouseholdBuilder.() -> Unit
// ) : HouseholdBuilder(id, seed, scope)

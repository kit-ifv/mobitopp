...
class DurationParser(
    ...
    /**
     * Returns the duration in the format of XDays YHours ZMinutes KSeconds. Integer valued and optionally a `-`
     * character in front for negative durations.
     * If duration is 0, then `0Seconds` is returned.
     */
    fun serialize(duration: Duration): String {
        var result = ""
        if (duration.isNegative()) result += "- "

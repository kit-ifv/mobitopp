...
enum class Bbsr17(override val code: Int, override val description: String) : RegionType {
    ...
    fun toRegioStaR17(): RegioStaR17 = when (this) {
...
fun RegioStaR17.toSizebasedClassification(): SizebasedRegiostarClassification = when (code) {
...
@Suppress("MagicNumber")
fun RegioStaR7.toSizebasedClassification(): SizebasedRegiostarClassification = when (code) {

...
class DrtProviderAgent(
    ...
    fun operatesAt(time: AbsoluteTime, origin: LocationOld, destination: LocationOld) =
...
interface DrtAlgorithm {
    ...
    fun operatesAt(time: AbsoluteTime, origin: LocationOld, destination: LocationOld): Boolean
...
data class DrtOffer(
    ...
    val origin: LocationOld,
    val pickupAt: LocationOld,
    val dropOffAt: LocationOld,
    val destination: LocationOld,
...
class SimpleMatrixDrtAlgorithm(
    ...
    override fun operatesAt(time: AbsoluteTime, origin: LocationOld, destination: LocationOld) =

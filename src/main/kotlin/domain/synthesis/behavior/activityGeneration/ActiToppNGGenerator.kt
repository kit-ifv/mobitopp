...
class ActiToppNGGenerator<in S, in T>(
     ...
     */
    private fun Sex.toGender(): Gender = when (this) {
    ...
    private fun Employment.toActitoppEmployment(): ActitoppEmployment = when (this) {
 ...
 */
fun ActitoppActivityType.toReengineeredType(purposes: ChoiceModelPurposes): ActivityType = when (this) {
 ...
 */
fun ZoneRegionType.toAreaType(): AreaType = when (this) {

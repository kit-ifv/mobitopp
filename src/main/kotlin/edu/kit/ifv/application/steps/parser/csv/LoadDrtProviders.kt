...
import edu.kit.ifv.domain.simulation.parser.DrtProviderByAreaCsvColumns
import edu.kit.ifv.domain.simulation.parser.DrtProviderByAreaCsvConfig
import edu.kit.ifv.domain.simulation.parser.GlobalDrtProviderIdCounter
import edu.kit.ifv.domain.simulation.parser.allDay
import edu.kit.ifv.domain.simulation.parser.createDrtProvidersByAreaParser

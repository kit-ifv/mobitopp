...
import edu.kit.ifv.domain.simulation.data.person.HasHousehold
import edu.kit.ifv.domain.simulation.data.sharing.HasStandardLocation
import edu.kit.ifv.domain.simulation.parser.FixedDestinationColumns
import edu.kit.ifv.domain.simulation.parser.FixedDestinationCsvConfig
import edu.kit.ifv.domain.simulation.parser.binary.FixedDestinationReader
import edu.kit.ifv.domain.simulation.parser.binary.FixedDestinationWriter
import edu.kit.ifv.domain.simulation.parser.createFixedDestinationCsvParser

...
import edu.kit.ifv.domain.simulation.parser.GetZone
import edu.kit.ifv.domain.simulation.parser.GlobalSharingProviderIdCounter
import edu.kit.ifv.domain.simulation.parser.GlobalSharingStationIdCounter
import edu.kit.ifv.domain.simulation.parser.SharingProviderByStationCsvColumns
import edu.kit.ifv.domain.simulation.parser.SharingProviderByStationCsvConfig
import edu.kit.ifv.domain.simulation.parser.allDay
import edu.kit.ifv.domain.simulation.parser.onlySameZoneByFoot
import edu.kit.ifv.domain.simulation.parser.sharingProviderStationParser
...
): Resource<MutableSharingProvider>
where C : HasZoneRepo<*, Zone<HasRegionType>>,
      CFG : SharingSourceFilesConfig,
 ...
 * @param parser The CSV parser. Defaults to [carSharingFloatAreaParser].
 * @param delimiter The CSV delimiter. Defaults to [config.sourceFiles.defaultCsvDelimiter].
 * @param binaryCache Optional configuration for binary caching.

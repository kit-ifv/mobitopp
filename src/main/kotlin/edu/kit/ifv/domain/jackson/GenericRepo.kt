...
class GenericKeyValueBuilder<T>(
    ...
    fun getSerializer(): GenericKeyValueSerializer<T> = GenericKeyValueSerializer(
        type,
        serializerMapping,
        false,
    )

    fun getDeserializer(): GenericKeyValueDeserializer<T> = GenericKeyValueDeserializer(
        type,
        deserializerMapping,
        false,
    )
     ...
     */
    fun getModule(): SimpleModule = SimpleModule("KeyValueSerializer of $type").apply {
        setSerializers(
            SpecificTypeSerializers(
                type,
                getSerializer(),
            ),
        )
...
class GenericKeyValueDeserializer<T>(
    ...
    override fun deserialize(p: JsonParser, ctxt: DeserializationContext?): T {
        ...
        return mapping[fieldValue] ?: error(
            "Unknown type: $fieldValue. Can't deserialize $fieldValue. " +
...
fun JavaType.isSameOrSubtypeOf(other: JavaType): Boolean =
    this == other || other in this.interfaces || this.isSubtypeOf(other)
 ...
 * ```
 */
fun javaType(type: Class<*>): JavaType = TypeFactory.defaultInstance().constructType(type)

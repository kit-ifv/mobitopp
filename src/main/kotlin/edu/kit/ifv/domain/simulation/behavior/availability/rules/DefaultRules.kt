...
fun AvailabilityByRuleBuilder.defaultCarAvailability(car: Mode) =
...
fun AvailabilityByRuleBuilder.defaultBikeRule(bike: Mode) =
...
fun AvailabilityByRuleBuilder.defaultDrtRules(drt: Mode) =
    availabilityOf(drt).staticRule {

...
import edu.kit.ifv.domain.synthesis.attributes.person.HasEmployment
import edu.kit.ifv.domain.synthesis.attributes.person.MinimumPersonAttributes
import edu.kit.ifv.domain.synthesis.attributes.person.isPrimaryStudent
import edu.kit.ifv.domain.synthesis.attributes.person.isSecondaryStudent
import edu.kit.ifv.domain.synthesis.attributes.person.isTertiaryStudent
import edu.kit.ifv.domain.synthesis.attributes.person.isWorker

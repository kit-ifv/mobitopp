...
data class CarParameters(
    var oneMember: Double,
    var twoMembers: Double,
    var fourOrMoreMembers: Double,
    var lowIncome: Double,
    var highIncome: Double,
    var childrenFactor: Double,
    var youthFactor: Double,
    var oneWorker: Double,
    var twoWorkers: Double,
    var oneLicence: Double,
    var twoLicences: Double,
    var threeLicences: Double,
    var fourOrMoreLicences: Double,
    var isFlat: Double,
    var isRetired: Double,
    var isUnemployed: Double,
    var mu: Double,
    var sigma: Double,
)
...
class CarOwnershipParameters(
    val asc_0_mu: Double = 0.0,
    val asc_0_sig: Double = 2.67593060385488,
    val asc_1_mu: Double = 0.420030501062286,
    val asc_1_sig: Double = -0.0321520185405091,
    val asc_2_mu: Double = 0.368067635941016,
    val asc_2_sig: Double = 4.58347401363783E-4,
    val asc_3_mu: Double = 0.309599866397395,
    val asc_3_sig: Double = -0.0128506565299745,
    val asc_4: Double = 0.27027029951076303,
    val b_hh_size_1_on_1: Double = -3.03972758525991,
    val b_hh_size_1_on_2: Double = -3.38452474375784,
    val b_hh_size_1_on_3: Double = -3.29131084074051,
    val b_hh_size_1_on_4: Double = -3.37573395032723,
    val b_hh_size_2_on_1: Double = -0.718269409894878,
    val b_hh_size_2_on_2: Double = -0.780969322578045,
    val b_hh_size_2_on_3: Double = -0.810594293834768,
    val b_hh_size_2_on_4: Double = -0.8581438677666421,
    val b_hh_size_4_on_1: Double = 0.848330308949847,
    val b_hh_size_4_on_2: Double = 0.852290307592964,
    val b_hh_size_4_on_3: Double = 0.8661976785324159,
    val b_hh_size_4_on_4: Double = 0.896825471631694,
    val b_income_low_on_1: Double = -1.56661976932426,
    val b_income_low_on_2: Double = -1.59297671279903,
    val b_income_low_on_3: Double = -1.59385035236844,
    val b_income_low_on_4: Double = -1.59769261885509,
    val b_income_high_on_1: Double = 1.08268911673901,
    val b_income_high_on_2: Double = 1.1350853798127,
    val b_income_high_on_3: Double = 1.1599647632117,
    val b_income_high_on_4: Double = 1.1567981811908101,
    val b_education_1_on_1: Double = 0.0,
    val b_education_1_on_2: Double = 0.0,
    val b_education_1_on_3: Double = 0.0,
    val b_education_1_on_4: Double = 0.0,
    val b_education_2_on_1: Double = 0.0,
    val b_education_2_on_2: Double = 0.0,
    val b_education_2_on_3: Double = 0.0,
    val b_education_2_on_4: Double = 0.0,
    val b_person_age_0_9_on_1: Double = -0.869349032505858,
    val b_person_age_0_9_on_2: Double = -0.909452047188882,
    val b_person_age_0_9_on_3: Double = -0.926288986018561,
    val b_person_age_0_9_on_4: Double = -0.93180031405934,
    val b_person_age_10_17_on_1: Double = -0.00794724968036045,
    val b_person_age_10_17_on_2: Double = -0.0219624250483548,
    val b_person_age_10_17_on_3: Double = -0.029801647082422,
    val b_person_age_10_17_on_4: Double = -0.035681526138492,
    val b_person_working_1_on_1: Double = -1.22908910461908,
    val b_person_working_1_on_2: Double = -1.2195353573398,
    val b_person_working_1_on_3: Double = -1.218323241698,
    val b_person_working_1_on_4: Double = -1.21977909853093,
    val b_person_working_2_on_1: Double = -1.63411786599527,
    val b_person_working_2_on_2: Double = -1.62448090895747,
    val b_person_working_2_on_3: Double = -1.62309602799223,
    val b_person_working_2_on_4: Double = -1.62356367470392,
    val b_license_1_on_1: Double = 5.09926672616369,
    val b_license_1_on_2: Double = 5.12739682956448,
    val b_license_1_on_3: Double = 5.13038846915259,
    val b_license_1_on_4: Double = 5.12656953796273,
    val b_license_2_on_1: Double = 5.71206620763584,
    val b_license_2_on_2: Double = 5.74786330947324,
    val b_license_2_on_3: Double = 5.74908851934019,
    val b_license_2_on_4: Double = 5.74399114538186,
    val b_license_3_on_1: Double = 6.04717465368787,
    val b_license_3_on_2: Double = 6.10619957285624,
    val b_license_3_on_3: Double = 6.11834038428974,
    val b_license_3_on_4: Double = 6.11070204049675,
    val b_license_4_on_1: Double = 6.10710612959228,
    val b_license_4_on_2: Double = 6.18064906514258,
    val b_license_4_on_3: Double = 6.19782128535075,
    val b_license_4_on_4: Double = 6.19275905159747,
    val b_shared_flat_on_1: Double = -1.89710718194422,
    val b_shared_flat_on_2: Double = -1.93403374165459,
    val b_shared_flat_on_3: Double = -1.93789041056075,
    val b_shared_flat_on_4: Double = -1.93789041056075,
    val b_hh_retired_on_1: Double = -0.426099220231941,
    val b_hh_retired_on_2: Double = -0.439459412733719,
    val b_hh_retired_on_3: Double = -0.441144051104201,
    val b_hh_retired_on_4: Double = -0.441144051104201,
    val b_hh_unemployed_on_1: Double = -1.82327048027482,
    val b_hh_unemployed_on_2: Double = -1.81337481153653,
    val b_hh_unemployed_on_3: Double = -1.81001905327479,
    val b_hh_unemployed_on_4: Double = -1.81001905327479,
    val lambda_car: Double = 0.0563786710826848,
    val lambda_two_more_car: Double = 0.0232092332380213,
    val lambda_root: Double = 1.0
) {
    /**

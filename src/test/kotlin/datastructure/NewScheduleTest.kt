...
class NewScheduleTest {
    ...
    private val activity1: Activity = RawActivity(START, 0.hours, 7.hours)
    private val leg1: Leg = RawLeg(7.hours, 0.5.hours, START, FOURTH)
    private val leg1b: Leg = RawLeg(7.5.hours, 0.5.hours, FOURTH, OTHER)
    private val activity2: Activity = RawActivity(OTHER, 8.hours, 4.hours)
    private val activity2b: Activity = RawActivity(OTHER, 12.hours, 4.hours)
    private val leg2: Leg = RawLeg(16.hours, 0.5.hours, OTHER, FOURTH)
    private val leg2b: Leg = RawLeg(16.5.hours, 3.5.hours, FOURTH, THIRD)
    private val activity3: Activity = RawActivity(THIRD, 20.hours, 10.hours)
...
//        val overNext = next.next
        ...
        assertEquals(overNext.item, sortedSetOf<Activity>(RawActivity(OTHER,  8.hours, 8.hours)))
    ...
    fun builderIsProper() {
        ...
        val legBlock1 = LegBlock(sortedSetOf(leg1, leg1b), newSchedule.actions)
        val activityBlock2 = ActivityBlock(sortedSetOf(activity2, activity2b), newSchedule.actions)
        val legBlock2 = LegBlock(sortedSetOf(leg2, leg2b), newSchedule.actions)
        val activityBlock3 = ActivityBlock(activity3, newSchedule.actions)

...
class TripViewTest {
    ...
    private val activity0 = RawActivity(START_LOC, 0.hours, 6.hours)
    private val activity1 = RawActivity(OTHER_LOC, 8.hours, 8.hours)
    private val activity2 =  RawActivity(THIRD_LOC, 17.hours, 2.hours)
    ...
    fun adaptingTripWorks() {
        ...
        schedule.assertEquals {
            + activity0
            + RawLeg(7.hours, 10.minutes, START_LOC, THIRD_LOC)
            + RawLeg(7.hours + 20.minutes, 10.minutes, THIRD_LOC, OTHER_LOC)
            + activity1
            + activity1.createLegTo(activity2)
            + activity2
        }
    ...
    private fun Schedule.assertEquals(functor: ScheduleBuilder.() -> Unit) {
